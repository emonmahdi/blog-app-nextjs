export default function HeroSlider() {
    return (
      <header className="relative w-[100%] h-[500px] bg-gray-900 text-white flex items-center justify-center">
        {/* Background Image */}
        <div
        ...
        <div className="relative text-center px-6">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Discover the latest trends, tutorials, and news in web development,
